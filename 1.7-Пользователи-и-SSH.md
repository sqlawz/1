...
<img width="287" height="89" alt="image" src="https://github.com/user-attachments/assets/74b1dd93-1fac-4a07-b19a-a191b34ab0b6" />
...
Подключаемся с `HQ-RTR` указав имя созданного пользователя, ip-адрес `HQ-SRV` и порт 2026. Далее вводим пароль.
